...
#+RESULTS:
| bash | c | cpp | cmake | css | elisp | go | html | javascript | json | make | markdown | python | toml | tsx | typescript | yaml |
...
#+begin_src emacs-lisp
  ...
  (with-eval-after-load 'org
    ...
    (add-to-list 'org-structure-template-alist '("py" . "src python :output results")))
